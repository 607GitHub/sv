# Edited by David Bikker on 2025-03-12 to obtain pickles of untrained speaker verification models
...
# CLI:
hparams_file = 'train_resnet.yaml'
...
#speaker_brain.modules.mean_var_norm_emb._load("mean_var_norm_emb.ckpt")

import pickle
  

with open('moduledict.pkl', 'wb') as file:
    pickle.dump(speaker_brain.modules, file)
